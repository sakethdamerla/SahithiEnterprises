                ...
                <div className="p-6 md:p-8">
                    ...
                    <div className="space-y-3">
                        <button
                            ...
                            className="w-full bg-[#5E35B1] text-white py-3.5 rounded-xl font-bold hover:bg-primary-700 transition-all shadow-lg shadow-primary-600/10 active:scale-95 text-sm tracking-wide"
                        >
                            Okay, Got it
                        </button>
                    </div>
